...
args = commandArgs(trailingOnly=TRUE); #accept arguments, first = training data file (needs to be oriented s.t. rows are patients and columns are features (otherwise transpose), including 1 col for labels) second file is list of cluster ranking, third file is validation data
